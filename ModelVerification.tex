...
The only other graphical visualization that has been found is that descibed in \cite{Sch13-MS},
...
\item for each type in the formulae:
      ...
      \item the domain elements as terms (unless implicit from their type), as a universally 
            quantified disjunction of equalities whose righthand sides are the domain element
            terms;
      ...
      \end{packed_itemize}
\item interpretation of the formulae constant and function symbols, using equalities whose lefthand
      sides are terms formed from symbols applied to type-promoted domain elements, and whose 
      righthand sides are type-promoted domain elements;
...
NEED TO TALK ABOUT CHECKING interpretation formula for consistency, using a trusted model
finder.
...
by using a trusted theorem proving ATP system to prove each of the given formulae from the 
interpretation formula.
The interpretation formula is supplied as an axiom, and each of the given formulae (or their
conjunction) is given as a conjecture to be proved.

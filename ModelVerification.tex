...
\item $R_I$ - For each $p/n \in P_\Sigma$, a mapping $p_I: D_I^n \mapsto \{\true,\false\}$.
\end{packed_itemize}
...
F^\wedge_{\varphi} &= \bigwedge_{\substack{(\overline{d_{I,i}} \mapsto d_I) \in f_I,\;f_I \in F_I \\
                                           D_{\varphi \mapsto I}(d_{\varphi,i}) = d_{I,i} \\
                                           D_{\varphi \mapsto I}(d_{\varphi}) = d_I}} 
                                 ( f(\overline{d_{\varphi,i}}) = d_{\varphi} ) \\
R^\wedge_{\varphi} &= \bigwedge_{\substack{(\overline{d_{I,i}} \mapsto \true) \in p_I\;p_I \in R_I \\
                                           D_{\varphi \mapsto I}(d_{\varphi,i}) = d_{I,i}}}
                                 p(\overline{d_{\varphi,i}}) \\
              &\wedge \bigwedge_{\substack{(\overline{d_{I,i}} \mapsto \false) \in p_I\;p_I \in R_I \\
                                           D_{\varphi \mapsto I}(d_{\varphi,i}) = d_{I,i}}}
...
\item $R_{I_{\varphi}} = R_I \circ D_{\varphi \mapsto I}$
\end{packed_itemize}
...
$I_{\varphi} \vdash R^\wedge_{\varphi}$:
...
%            $f_I(F_{I_{\varphi}}(\overline{d_{\varphi,i}})) = F_{I_{\varphi}}(d_{\varphi})$ iff \\
      ...
      \item Every equality in $F^\wedge_{\varphi}$ is $\true$
      \end{packed_itemize}
      $F^\wedge_{\varphi}$ is $\true$, i.e.,
      $I_{\varphi} \vdash F^\wedge_{\varphi}$
\item For every (positive) $p(\overline{d_{\varphi,i}})$ in $R^\wedge_{\varphi}$:
      \begin{packed_itemize}
      \item $I_{\varphi} \vdash p(\overline{d_{\varphi,i}})$ iff \\
            $R_{I_{\varphi}}(p(\overline{d_{\varphi,i}}))$ iff \\
            $R_{I}(D_{\varphi \mapsto I}(\overline{d_{\varphi,i}}))$ iff \\
            $p_I(\overline{d_{I,i}})$ \\
            which is $\true$ from the use of $R_I$ in $R^\wedge_{\varphi}$
      \item Every (positive) $p(\overline{d_{\varphi,i}})$ in $R^\wedge_{\varphi}$ is $\true$
      \item Analogously, every (negative) $\neg p(\overline{d_{\varphi,i}})$ in
            $R^\wedge_{\varphi}$ is $\false$ \\
      \end{packed_itemize}
      $R^\wedge_{\varphi}$ is $\true$, i.e., $I_{\varphi} \vdash R^\wedge_{\varphi}$
\end{itemize}
\end{proof}

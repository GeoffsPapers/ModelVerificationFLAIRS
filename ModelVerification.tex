...
There exist several tools for visualizing proofs.
Evonne \footnote{\smalltt{https://lat.inf.tu-dresden.de/research/papers/2022/ALBABODAKOME-IJCAR22.pdf}}
is an interactive proof visualization software for description logics.
ProofTree \footnote{\smalltt{https://askra.de/software/prooftree/}} is a visualization tool focused on interactive theorem proving via Coq. ProofTree currently only supports proofs from Coq.
Treehehe \footnote{\smalltt{https://chelsea.lol/Resources/COMP5209\_BattellC\_report.pdf}} was designed generically to visualize
any proof tree, but currently it only supports a handful of pre-existing proofs and does not allow users to visualize their own proofs.

%Anything from Dedukti?,
The Interactive Derivation Viewer (IDV)\cite{TPS07} is a tool which supports visualization of TPTP formatted proofs.
Originally, it was a Java applet, but has since been ported to HTML/JavaScript and is available online through SystemOnTSTP.

...
has to be manually translated to extract different components of the interpretation formula
into separate annotated formulae, to mimic a derivation that IDV can render.

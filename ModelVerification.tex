...
R^\wedge_{\varphi} &= \bigwedge_{\substack{(\overline{d_{I,i}} \mapsto \true) \in p_I\;p_I \in P_I \\
                                           D_{\varphi \mapsto I}(d_{\varphi,i}) = d_{I,i}}}
                                 p(\overline{d_{\varphi,i}}) \\
              &\wedge \bigwedge_{\substack{(\overline{d_{I,i}} \mapsto \false) \in p_I\;p_I \in P_I \\
                                           D_{\varphi \mapsto I}(d_{\varphi,i}) = d_{I,i}}}
...
\item $P_{I_{\varphi}} = P_I \circ D_{\varphi \mapsto I}$
\end{packed_itemize}
...
\item For every (positive) $p(\overline{d_{\varphi,i}})$ in $R^\wedge_{\varphi}$:
      ...
      \item $I_{\varphi} \vdash p(\overline{d_{\varphi,i}})$ iff \\
            $P_{I_{\varphi}}(p(\overline{d_{\varphi,i}}))$ iff \\
            $P_{I}(D_{\varphi \mapsto I}(\overline{d_{\varphi,i}}))$ iff \\
            $p_I(\overline{d_{I,i}})$ \\
            which is $\true$ from the use of $P_I$ in $R^\wedge_{\varphi}$
      \end{packed_itemize}
      Thus every (positive) $p(\overline{d_{\varphi,i}})$ in $R^\wedge_{\varphi}$ is $\true$.
      Analogously, every (negative) $\neg p(\overline{d_{\varphi,i}})$ in $R^\wedge_{\varphi}$ is 
      $\false$.
     Therefore  $R^\wedge_{\varphi}$ is $\true$, i.e., $I_{\varphi} \vdash R^\wedge_{\varphi}$
\end{itemize}
\end{proof}

...
Old way of representing finite models, and format from other ATP/ITP systems.
...
The web page {\small {\tt https://www.tptp.org}} provides access to all components.
...
Figure~\ref{TF0FiniteProblem} is a problem in TF0\footnote{%
{\scriptsize {\tt https://raw.githubusercontent.com/ GeoffsPapers/ModelVerification/main/TFF\_Finite.p}}}
that has a finite countermodel, and Figure~\ref{TF0InfiniteProblem} is a problem in TF0\footnote{%
{\scriptsize {\tt https://raw.githubusercontent.com/ GeoffsPapers/ModelVerification/main/TFF\_Infinite.p}}}
...
An interpretation of formulae in a classical logic consists of domains (one for each type -
...
A domain of an interpretation may be finite or infinite.
...
finite Herbrand Universe of a Herbrand interpretation \cite{}.
...
New role {\small {\tt interpretation}}.
Multiple interpretations in one file.

Figure~\ref{TF0FiniteInterpretation} is an interpretation with a finite domain\footnote{%
{\scriptsize {\tt https://raw.githubusercontent.com/ GeoffsPapers/ModelVerification/main/TFF\_Finite.s}}}
- it is a countermodel for the problem in Figure~\ref{TF0FiniteProblem}.
...
Figure~\ref{TF0InfiniteInterpretation} is an interpretation with a infinite domain \footnote{%
{\scriptsize {\tt https://raw.githubusercontent.com/ GeoffsPapers/ModelVerification/main/TFF\_Infinite.s}}}
- it is a model for the problem in Figure~\ref{TF0InfiniteProblem}.
...
Figure~\ref{TF0InfiniteVerification} is the verification problem\footnote{%
{\scriptsize {\tt https://raw.githubusercontent.com/ GeoffsPapers/ModelVerification/main/TFF\_Infinite.s.p}}}
for the problem in Figure~\ref{TF0InfiniteProblem} and its model in 

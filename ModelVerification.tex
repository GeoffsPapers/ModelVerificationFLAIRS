...
the {\smalltt{interpretation}} formula that represent the model found by the ATP system, and
...
\item This can be empirically confirmed using a trusted model finder (in the same way the GDV 
      ...
      theorem prover).
      Confirming that the {\smalltt{interpretation}} formula is satisfiable is almost certainly much 

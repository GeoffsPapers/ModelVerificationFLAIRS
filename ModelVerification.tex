...
\pdfinfo{
/Title (Representation, Verification, and Visualization of Classical Interpretations for First-order Logic)
...
Classical Interpretations for First-order Logic}
\author{Anon One\\
Some where\\
Some place\\
Some country\\
...
Figure~\ref{TF0FiniteIIV} is the visualization of the countermodel in 
...
\caption{Visualization of an interpretation}
\label{TF0FiniteIIV}
\end{figure}

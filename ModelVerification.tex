...
reducing the visual clutter when displaying relations with properties such as
symmetry, transitivity, etc.
In other ways that work was quite different from the one described in this work.
...
ProofTree\footnote{\smalltt{https://askra.de/software/prooftree/}} is a proof visualization tool focused on interactive theorem proving within Coq. ProofTree currently only supports proofs from Coq.

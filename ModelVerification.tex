...
Figure~\ref{TF0FiniteProblem} is a problem in TF0\footenote{%
} that has a finite countermodel - see Section~\ref{Interpretations}. 
Figure~\ref{TF0InfiniteProblem} is a problem 
in TF0\footnote{%
{\scriptsize {\tt https://raw.githubusercontent.com/GeoffsPapers/Model Verification/main/TFF\_Infinite.p}}.}
...
New role {\tt interpretation}.
Multiple interpretations in one file.

Figure~\ref{TF0FiniteInterpretation} is an interpretation with a finite domain - it is a 
countermodel for the problem in Figure~\ref{TF0FiniteProblem}.\footnote{%
{\scriptsize {\tt https://raw.githubusercontent.com/GeoffsPapers/Model Verification/main/TFF\_Finite.s}}.}
...
Figure~\ref{TF0InfiniteInterpretation} is an interpretation with a infinite domain - it is a 
countermodel for the problem in Figure~\ref{TF0InfiniteProblem}.\footnote{%
{\scriptsize {\tt https://raw.githubusercontent.com/GeoffsPapers/Model Verification/main/TFF\_Infinite.s}}.}
...
{\scriptsize {\tt https://raw.githubusercontent.com/GeoffsPapers/Model Verification/main/TFF\_Finite.s.IDV}}

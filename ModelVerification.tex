...
For visualization the only other work that has been found is \cite{Sch13-MS}.
This provides a visualization of finite first-order interpretations, as
produced by Paradox.
The visualization is quite different from that described in this work.

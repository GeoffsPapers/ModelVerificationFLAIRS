...
that has a finite countermodel - see Section~\ref{Interpretations}. 
Figure~\ref{TF0InfiniteProblem} is a problem 
in TF0\footnote{%
{\scriptsize {\tt https://raw.githubusercontent.com/ GeoffsPapers/ModelVerification/main/TFF\_Infinite.p}}}
that has an model with an infinite domain - see Section~\ref{Interpretations}.
...
It show the situation with the cursor hovering over the lower {\tt d\_john} node on the path

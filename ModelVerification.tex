...
D^{\neq}_{\varphi_I}   &= \bigwedge_{d_{\varphi_I},e_{\varphi_I} \in D_{\varphi_I}} \left(d_{\varphi_I} \neq e_{\varphi_I} \right) \\
...
\item For each $(d_{\varphi_I} \neq e_{\varphi_I})$ of the conjunction $D^{\neq}_{\varphi_I}$:
      \begin{packed_itemize}
      \item fooo
      \item Each inequality of the conjunction $D^{\neq}_{\varphi_I}$ is $\true$
      \end{packed_itemize}

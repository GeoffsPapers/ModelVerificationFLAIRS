...
Visualization of interpretations is useful in the areas where models are instrumental, and also 
in teaching logic or formal methods, as debugging tools for ATP system developers, and for 
helping humans understand the essence of a model.
...
{\smalltt{\url{https://raw.githubusercontent.com/GeoffsPapers/ModelVerification/main/TFF_Finite.s.IIV}}}
